...
def sudoku_mutation(ind):
    mut_point = (randint(0, len(ind.representation) - 1),randint(0, len(ind.representation) - 1))
    ...
    if mut_point in ind.given_index:
        pass
    else:
        ...
        for i in possible_values:
            if i in possible_block and i in possible_row and i in possible_column:
                pass
            else:
        ...
        ind.fill_values[change_index] = choice(possible_values)
