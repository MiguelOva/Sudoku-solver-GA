...
from CIFO_PROJECT.charles.selection import fps, tournament, ranking_selection, roulette_wheel
from CIFO_PROJECT.charles.mutation import binary_mutation, swap_mutation, inversion_mutation, sudoku_mutation
from CIFO_PROJECT.charles.crossover import single_point_co, pmx_co, cycle_co, arithmetic_co
...
if __name__ == '__main__':
    Pop = Population(size = 1000, optim="min", cues = very_easy_)
    Pop.evolve(1000,select=ranking_selection, crossover = single_point_co, mutate= swap_mutation, co_p=0.9, mu_p=0.1,
             elitism=True, cues = very_easy_)
